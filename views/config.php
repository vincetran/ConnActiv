	...
	//check to make sure the required fields were filled in.
		...
		if($check2 == 0){
			...
			if(strcmp($_POST['password'], $_POST['confirm'])==0){			
				...
				$query = "Insert into Users(email,FIRST_NAME, LAST_NAME, STREET, CITY, STATE, ZIP, PHONE, INTERESTS, 				PASSWORD)  values('".$_POST['username']."','".$_POST['firstName']."','".$_POST['lastName']."','".
				$_POST['street']."','".$_POST['city']."','".$_POST['state']."','".$_POST['zip']."','".$_POST['phone']."','".
				$_POST['interests']."','".md5($_POST['password'])."'";
				var_dump($query);
				...
				foreach($_POST['activities'] as $act){
					...
					$insert = mysql_query("Insert into USER_ACTIVITIES(USER_ID, ACTIVITY_ID) values('".$userid1
					['USER_ID']."','".$activityid1['ACTIVITY_ID']."'");
				}
